      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-500/10 text-amber-300 border border-amber-500/30 text-xs font-bold uppercase tracking-wider">
            <Sparkles className="w-3.5 h-3.5 text-amber-400" /> Transformatif & Benefit Utama
          </div>
        ...
        {/* 4 Pain Points / Benefits vs Solution Grid */}
          ...
          {PAIN_POINTS.map((item, index) => (
            ...
            >
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl bg-amber-500/10 border border-amber-500/30 flex items-center justify-center shrink-0 mt-1">
                ...
                <div className="space-y-2 flex-1">
                  ...
                  <div className="mt-4 pt-3 border-t border-slate-800/80 bg-blue-950/20 -mx-6 -mb-6 p-4 rounded-b-2xl border-l-2 border-l-amber-400">
                    <div className="text-[11px] font-bold text-amber-300 uppercase tracking-wider flex items-center gap-1.5 mb-1">
                      <Zap className="w-3.5 h-3.5 text-amber-400" /> Hasil Transformasi:
                    </div>
        ...
        {/* Transformation Banner - Methodology / CTA */}
